...
@section('title', 'Pricing - Flag Subscription Service')
                        ...
                        @foreach($flags as $flag)
                            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                                <div class="h-40 bg-gradient-to-br from-blue-100 to-red-100 flex items-center justify-center">
                                    <img src="{{ $flag->image_url }}" alt="{{ $flag->name }}" class="h-full object-contain p-4">
                                </div>
                                <div class="p-6">
                                    ...
                                    @endif
                                    <h3 class="text-xl font-bold mb-2">{{ $flag->name }}</h3>
                                    <p class="text-gray-600 text-sm mb-4">{{ $flag->description }}</p>
