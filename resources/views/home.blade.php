...
@section('title', 'Home - Professional Flag Display Service')
        ...
        <div class="max-w-3xl">
            ...
            @if($nextEvent)
                <div class="bg-white/10 backdrop-blur-sm p-4 rounded-lg inline-block mb-8">
                    <p class="font-medium">
                        Next flag placement: <span class="font-bold text-red-400">{{ $nextEvent->name }}</span>
                        on {{ $nextEvent->date->format('F j, Y') }}
                    </p>
                </div>
            @endif
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <button onclick="addToCart({{ $flag->id }}, '{{ $flag->name }}')"
