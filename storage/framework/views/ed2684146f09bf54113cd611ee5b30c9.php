<?php $__env->startSection('title', 'Sign Up - Flag Subscription Service'); ?>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-6">
                ...
                <div class="flex items-start">
                    ...
                    <label for="terms" class="ml-2 block text-sm text-gray-700">
                        I agree to the
                        <a href="<?php echo e(route('terms')); ?>" class="text-blue-900 hover:text-blue-700" target="_blank">Terms of Service</a>
                        and
                        <a href="<?php echo e(route('privacy')); ?>" class="text-blue-900 hover:text-blue-700" target="_blank">Privacy Policy</a>
                    </label>
                </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="text-blue-900 hover:text-blue-700 font-medium">
                        Sign in
                    </a>
                </p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/xavierporter/Sites/localhost-new/FoC/resources/views/auth/register.blade.php ENDPATH**/ ?>